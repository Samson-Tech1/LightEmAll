...
//EXTRA CREDIT:
//- enhanced graphics by adding color gradient
//- kept track of score which is displayed during the game
//- gave players the option to restart game without restarting program
//- gave players the option to "give up" in the game and see the correct solution
...
class LightEmAll extends World {
  ...
  public WorldScene makeScene() {
    ...
    scene.placeImageXY(new TextImage("f to give up :(", 
        11, FontStyle.BOLD, Color.WHITE), 45 * width, height + 150);
